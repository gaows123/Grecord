\hypertarget{grid__path_8h_source}{}\doxysection{grid\+\_\+path.\+h}
\label{grid__path_8h_source}\index{global\_planner/include/global\_planner/grid\_path.h@{global\_planner/include/global\_planner/grid\_path.h}}
\mbox{\hyperlink{grid__path_8h}{浏览该文件的文档.}}
\begin{DoxyCode}{0}
...
\DoxyCodeLine{38 \textcolor{preprocessor}{\#ifndef \_GRID\_PATH\_H}}
\DoxyCodeLine{39 \textcolor{preprocessor}{\#define \_GRID\_PATH\_H}}
...
\DoxyCodeLine{44 }
\DoxyCodeLine{45 \textcolor{keyword}{class }\mbox{\hyperlink{classglobal__planner_1_1_grid_path}{GridPath}} : \textcolor{keyword}{public} \mbox{\hyperlink{classglobal__planner_1_1_traceback}{Traceback}} \{}
\DoxyCodeLine{46     \textcolor{keyword}{public}:}
\DoxyCodeLine{47         \mbox{\hyperlink{classglobal__planner_1_1_grid_path_ad4b6453a13dc23b79e684e9e2092c25c}{GridPath}}(\mbox{\hyperlink{classglobal__planner_1_1_potential_calculator}{PotentialCalculator}}* p\_calc): \mbox{\hyperlink{classglobal__planner_1_1_traceback}{Traceback}}(p\_calc)\{\}}
\DoxyCodeLine{48         \textcolor{keyword}{virtual} \mbox{\hyperlink{classglobal__planner_1_1_grid_path_a50c4072ebc32cd69663fcf255c394914}{\string~GridPath}}() \{\}}
\DoxyCodeLine{49         \textcolor{keywordtype}{bool} \mbox{\hyperlink{classglobal__planner_1_1_grid_path_a11f2838b30fdaca0e29ccff49d0e6c58}{getPath}}(\textcolor{keywordtype}{float}* potential, \textcolor{keywordtype}{double} start\_x, \textcolor{keywordtype}{double} start\_y, \textcolor{keywordtype}{double} end\_x, \textcolor{keywordtype}{double} end\_y, std::vector<std::pair<float, float> >\& path);}
\DoxyCodeLine{50 \};}
\DoxyCodeLine{51 }
\DoxyCodeLine{52 \} \textcolor{comment}{//end namespace global\_planner}}
